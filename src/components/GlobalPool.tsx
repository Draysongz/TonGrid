import { Droplets, Clock, TrendingUp, Users } from 'lucide-react';
      ...
      <div className="grid grid-cols-2 gap-4 mb-6">
        <div className="p-4 rounded-xl bg-gradient-to-br from-tongrid-blue/20 to-tongrid-violet/20 border border-tongrid-blue/30">
          ...
          <p className="font-mono font-bold text-tongrid-white text-2xl">
            {poolData.totalPool.toLocaleString()} TON
          </p>
        ...
        <div className="p-4 rounded-xl bg-tongrid-cyan/10 border border-tongrid-cyan/30">
          ...
          <p className="font-mono font-bold text-tongrid-cyan text-2xl">
            +{poolData.yourShare.toFixed(2)} TON
          </p>
          <p className="text-tongrid-gray/70 text-xs mt-1">
            Score: {poolData.yourScore.toLocaleString()}
          </p>
        </div>
      </div>
        ...
        <div className="flex items-center justify-between">
          <div className="flex gap-4">
            <div className="text-center">
              <p className="font-mono font-bold text-tongrid-white text-2xl">2</p>
              <p className="text-tongrid-gray text-xs">Days</p>
            </div>
            <div className="text-center">
              <p className="font-mono font-bold text-tongrid-white text-2xl">14</p>
              <p className="text-tongrid-gray text-xs">Hours</p>
            </div>
            <div className="text-center">
              <p className="font-mono font-bold text-tongrid-white text-2xl">32</p>
              <p className="text-tongrid-gray text-xs">Minutes</p>
            </div>
          </div>
          <div className="text-right">
            <Users className="w-5 h-5 text-tongrid-gray mb-1" />
            <p className="text-tongrid-gray text-xs">{poolData.totalParticipants.toLocaleString()} participants</p>
          </div>
        </div>
      </div>
